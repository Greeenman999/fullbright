...
dependencies {
    ...
    jarJar(implementation("gg.essential:elementa") {}) {
        version {
...
//    "additionalRuntimeClasspath"("gg.essential:elementa:${prop("deps.elementa")}")
    jarJar(implementation("gg.essential:universalcraft-${prop("deps.universalcraft-mc")}-neoforge") {}) {
        version {
...
//    "additionalRuntimeClasspath"("gg.essential:universalcraft-${prop("deps.universalcraft-mc")}-neoforge:${prop("deps.universalcraft")}")
